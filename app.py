...
st.title("Acoustic Leak‑Net — Web Dashboard")
st.caption("Simulate a leak, detect it, and localize it in-browser (Streamlit demo).")
...
if run:
    ...
    # Download pitch report bundle (md + images + results.json)
    st.subheader("Export")
